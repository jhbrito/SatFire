...
if os.path.isfile('./maximum_shapes_width190_600.txt'):

    with open('maximum_shapes_width190_600.txt', 'r+') as f:
    ...
    for shape_index, shape in enumerate(sf.shapes()): #loop shapes files
        ...
        if (x_dist >= 0.190 and x_dist < 0.6) and (y_dist >= 0.190 and y_dist < 0.6):
...
# save data on text file
    with open('maximum_shapes_width190_600.txt', 'w') as f:
...
ax1.set_title('Number of Forest Fire vs Fire Width in 2017')
